      ...
      <div className="flex items-center justify-center flex-col gap-4 bg-[#4a4a4a] rounded-3xl p-12">
        ...
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-2 bg-[#242424] p-2 rounded-lg">
            ...
            <input className="outline-none bg-transparent  border-b-2 border-white text-white" type="text"/>
          </div>
          <div className="flex items-center gap-2 bg-[#242424] p-2 rounded-lg">
        ...
        <div className="flex items-center justify-between w-[300px]">
          ...
          <button className="bg-blue-400 px-4 py-2 rounded-3xl font-semibold hover:bg-blue-600 hover:text-white duration-300 outline-none" >Log in</button>
        </div>
      </div>
    </div>
  )
